...
export type DropdownMenuStyledConfig<
  Item extends string,
  _ParentMessage,
> = Readonly<{
          ...
          [
            ...(spec.icon !== undefined
              ? iconBox
                ? [
                    h.div(
                      elAttrs<ParentMessage>(
                        sxAttrs(h, dropdownMenuStyles.iconBox),
                      ),
                      [
                        h.span(
                          elAttrs<ParentMessage>(
                ...
                : [
                    h.span(
                      elAttrs<ParentMessage>(
                        sxAttrs(h, dropdownMenuStyles.itemIcon),
                      ),
                      [spec.icon],
                    ),
                  ]
            ...
            ...(spec.shortcut !== undefined
              ? [
                  h.span(
                    elAttrs<ParentMessage>(
                      sxAttrs(h, dropdownMenuStyles.shortcut),
                    ),
                    [spec.shortcut],
                  ),
                ]
...
export { Model, Message } from '@foldkit/ui/menu'
